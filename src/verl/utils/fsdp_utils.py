...
def get_fsdp_wrap_policy_vla(module, is_lora = False):
    ...
    siglip_wrap_policy = functools.partial(transformer_auto_wrap_policy, transformer_layer_cls={SiglipEncoderLayer})
    ...
    projector_wrap_policy = functools.partial(
        _module_wrap_policy,
        module_classes={PaliGemmaMultiModalProjector},
    )
